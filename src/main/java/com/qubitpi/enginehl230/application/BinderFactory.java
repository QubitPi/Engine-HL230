...
import io.github.qubitpi.athena.filestore.swift.SwiftFileStore;
import io.github.qubitpi.athena.metadata.MetaData;
import io.github.qubitpi.athena.metastore.MetaStore;
import io.github.qubitpi.athena.metastore.graphql.GraphQLMetaStore;
...
/**
 * Video specialization of the Abstract Binder Factory, applying VK-45.01 webservice configuration objects.
 */
public class BinderFactory extends AbstractBinderFactory {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(BinderFactory.class);
    ...
    /**
     * Binds the required CORS filter which Athena does not include.
     *
     * @param resourceConfig  The Athena's resource configuration object passed down into its application, i.e.
     * Engine-HL230
     */
    @Override
    public void afterRegistration(final ResourceConfig resourceConfig) {
        super.afterRegistration(resourceConfig);
    ...
    /**
     * Spins up a JDBC DataSource factory instance using the Engine-HL230 configs.
     *
