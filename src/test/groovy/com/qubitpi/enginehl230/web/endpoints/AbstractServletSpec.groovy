 ...
 */
package com.qubitpi.enginehl230.web.endpoints

import com.qubitpi.enginehl230.JettyServerFactory
import com.qubitpi.enginehl230.application.SQLDBResourceManager
...
abstract class AbstractServletSpec extends Specification {
    ...
    def setupSpec() {
        ...
        SYSTEM_CONFIG.setProperty('athena__data_source_provider', 'com.qubitpi.enginehl230.application.BinderFactory$DerbyDataSourceProvider')
    }
